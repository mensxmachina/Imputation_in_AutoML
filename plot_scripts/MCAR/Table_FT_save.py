...
res=pd.read_csv('MCAR-FT-Results.csv',sep=';')
...
res_Ft_10.round(3).to_csv('Table-FT/10_MCAR_FT.csv',sep=';',index=datalist_10)


res_Ft_25 = res_Ft.loc[list_25]
res_Ft_25.index = datalist_25
res_Ft_25.round(3).to_csv('Table-FT/25_MCAR_FT.csv',sep=';',index=datalist_25)


res_Ft_50 = res_Ft.loc[list_50]
res_Ft_50.index = datalist_50
res_Ft_50.round(3).to_csv('Table-FT/50_MCAR_FT.csv',sep=';',index=datalist_50)
