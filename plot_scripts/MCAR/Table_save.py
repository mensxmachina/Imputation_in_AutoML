...
res=pd.read_csv('MCAR_Holdout_Results.csv',sep=';')
...
res_no_Ft_10.round(3).to_csv('Tables/10_MCAR_no_FT.csv',sep=';',index=datalist_10)


res_no_Ft_25 = res_no_Ft.loc[list_25]
res_no_Ft_25.index = datalist_25
res_no_Ft_25.round(3).to_csv('Tables/25_MCAR_no_FT.csv',sep=';',index=datalist_25)


res_no_Ft_50 = res_no_Ft.loc[list_50]
res_no_Ft_50.index = datalist_50
res_no_Ft_50.round(3).to_csv('Tables/50_MCAR_no_FT.csv',sep=';',index=datalist_50)
...
res_Ft_10.round(3).to_csv('Tables/10_MCAR_FT.csv',sep=';',index=datalist_10)


res_Ft_25 = res_Ft.loc[list_25]
res_Ft_25.index = datalist_25
res_Ft_25.round(3).to_csv('Tables/25_MCAR_FT.csv',sep=';',index=datalist_25)


res_Ft_50 = res_Ft.loc[list_50]
res_Ft_50.index = datalist_50
res_Ft_50.round(3).to_csv('Tables/50_MCAR_FT.csv',sep=';',index=datalist_50)
...
res_overall_10.round(3).to_csv('Tables/10_MCAR_Overall.csv',sep=';',index=datalist_10)

res_overall_25 = best_overall.loc[list_25]
res_overall_25.index = datalist_25
res_overall_25.round(3).to_csv('Tables/25_MCAR_Overall.csv',sep=';',index=datalist_25)


res_overall_50 = best_overall.loc[list_50]
res_overall_50.index = datalist_50
res_overall_50.round(3).to_csv('Tables/50_MCAR_Overall.csv',sep=';',index=datalist_50)
