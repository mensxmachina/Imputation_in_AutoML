...
plt.title('Average AUC difference from complete dataset in MCAR simulation')
#['MM','BI+MM','GAIN','BI+GAIN','MF','BI+MF','SOFT','BI+SOFT','PPCA','BI+PPCA']
...
best_overall = res_overall_tradeoff[['BI+MM','BI+MF','BI+GAIN','BI+SOFT','BI+PPCA','BI+DAE']] #['Best','MM','MF','GAIN','SOFT','PPCA','DAE'] #['BI+MF','BI+SOFT','BI+MM','BI+PPCA','BI+DAE','BI+GAIN']
legend_elements = []
auc_avg = []
...
mng = plt.get_current_fig_manager()
mng.full_screen_toggle()
plt.savefig('plots/MCAR_Difference_From_baseline_with_and_without_fs-NoIndi.png',bbox_inches='tight')
plt.close()
...
print(avg_features)
avg_features.to_csv('MCAR_Avg_auc.csv',sep=';')
